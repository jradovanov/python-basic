...
For this purpose, you have to download and install first the Python language.
...
work. The most popular environment for Python is PyCharm.
...
Second: Set the project directory and name it.
        leaved the Base interpreter field filled with the default value.
...
That is all for now. If you want a new directory or a new file, follow the described steps above.
